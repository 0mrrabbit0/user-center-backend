...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("com.example.usercenter")).paths(PathSelectors.any())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("用户中心").description("用户中心swagger文档").termsOfServiceUrl("")
                .version("2.0").build();
    }
    /**
